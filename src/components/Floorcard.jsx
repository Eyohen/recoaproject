...
const Floorcard = ({community}) => {
    ...
    //   try{
    //     const res = await axios.get(URL+"/api/communitys"+param)
  ...
  return (
    <div>
      <p className='text-center text-lg'>{community?.name}</p>
    </div>
  ...
  // </div> */}
  //  <img src={IF+community.photo ? IF+community.photo : "https://www.svgrepo.com/show/340721/no-image.svg"} alt='' className='w-[450px] h-[250px] object-cover rounded-3xl brightness-75'/>
