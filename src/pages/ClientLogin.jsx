  ...
  return (
    <>
      <div className="relative">
        <img
          src={"https://newsverge.com/wp-content/uploads/2021/03/Shell.jpeg"}
          alt=""
          className="w-full h-screen object-cover brightness-75"
        />

        <div class="absolute top-[200px] left-[550px] w-full">
          <p className="text-white absolute font-bold text-5xl ml-20 text-center ">
            Shell Nigeria
          </p>
          ...
          <input
            ...
            className="absolute w-[530px] h-9 rounded-lg mt-16"
            type="text"
            placeholder="Enter your email"
          />
          <input
            onChange={(e) => setPassword(e.target.value)}
            className="absolute w-[530px] h-9 rounded-lg mt-32"
            type="password"
          ...
          <button
            onClick={handleLogin}
            className="px-16 py-4 mx-[150px] text-lg font-bold text-white border-2 rounded-full hover:bg-gray-500 hover:text-black mt-64"
          >
            Log in
          </button>
        </div>
