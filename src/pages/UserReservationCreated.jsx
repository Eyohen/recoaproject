    ...
    <div className="w-full">
      ...
      <div className="max-w-[1100px] bg-white mx-auto">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg mt-16">
          <h1 className="font-bold text-xl mt-10 text-center">Tenant User Reservations</h1>
            ...
            <tbody>
              {reservations.map((reservation) => (
                <tr
                  ...
                  key={reservation._id}
                >
                  <td className="px-6 py-2">{reservation.reservation._id.slice(0, 6)}</td>
                  <td className="px-6 py-2">{reservation.reservation.unitType.name}</td>
                  <td className="px-6 py-2">
                    {reservation.reservation.tenant ? reservation.reservation.tenant.tenant : null}
                  </td>
                  <td className="px-6 py-2">{reservation.reservation.count}</td>
                  <td className="px-6 py-2">
                    <SlTrash
